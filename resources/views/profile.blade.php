...
<div class="container">
    <div class="box fs-montserrat">
      ...
      <div class="mt-3">
        ...
        <button type="button" class="btn btn-secondary" style="border: none; background:none; padding: 0;" data-bs-toggle="modal" data-bs-target="#buttonPhoto">
          Change Profile
        </button>
      </div>
    ...
    <div class="About fs-montserrat">
        ...
        <ul>
            <h3>Name<button class="tombol button btn-sm mx-3 text-light bg-primary border-0"  data-bs-toggle="modal" data-bs-target="#buttonName">edit</button></h3>
            <li>{{ $user->name }}</li>
        </ul>
        <ul>
            <h3>Username<button class="tombol button btn-sm mx-3 text-light bg-primary border-0"  data-bs-toggle="modal" data-bs-target="#buttonUsername">edit</button></h3>
            <li>{{ $user->username }}</li>
        </ul>
        <ul>
            <h3>Email<button class="tombol button btn-sm mx-3 text-light bg-primary border-0"  data-bs-toggle="modal" data-bs-target="#buttonEmail">edit</button></h3>
            <li>{{ $user->email }}</li>
        </ul>
        <ul>
            <h3>Alamat<button class="tombol button btn-sm mx-3 text-light bg-primary border-0"  data-bs-toggle="modal" data-bs-target="#buttonAlamat">edit</button></h3>
            @if ($user->alamat_id == null)
              <li>
                <button class="tombol button btn-sm mx-3 text-light bg-primary border-0 mt-3"  data-bs-toggle="modal" data-bs-target="#buttonAlamat">Tambah Alamat</button>
              </li>
            @else
              <li>{{ $user->alamat->jalan }} kel.{{ $user->alamat->kelurahan}} kec.{{ $user->alamat->kecamatan}} Kota {{ $user->alamat->kota}} Kode Pos {{ $user->alamat->kodePos }} </li>
            @endif
            
        </ul>
        <ul>
            <h3>Phone<button class="tombol button btn-sm mx-3 text-light bg-primary border-0"  data-bs-toggle="modal" data-bs-target="#buttonPhone">edit</button></h3>
            <li>{{ $user->phone }}</li>
        </ul>
    </div>
</div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3">
          <label for="photo" class="form-label @error('photo') is-invalid @enderror">Photo Profile</label>
...
<div class="modal fade" id="buttonUsername" tabindex="-1" aria-labelledby="buttonUsernameLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      @if ($alamat->count())
          ...
          <div class="mb-3">
            <div class="mb-3">
             ...
             <select class="form-select" name="alamat_id" >
                ...
                @else
                  <option value="{{ $a->id }}">{{ $a->jalan }} Kel.{{ $a->kelurahan }} Kec.{{ $a->kecamatan }} Kota {{ $a->kota }} {{ $a->kodePos }}</option>
                @endif
                @endforeach
             </select>
            </div>
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahAlamat">Tambah Alamat</button>
        </div>
...
<div class="modal fade" id="tambahAlamat" tabindex="-1" aria-labelledby="tambahAlamatLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3">
          <input type="hidden" class="form-control @error('user_id') is-invalid @enderror" id="user_id" name="user_id" value="{{ $user->id }}">
